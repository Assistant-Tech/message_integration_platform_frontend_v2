...
/**
 * Admin-dashboard placeholder data. Replaced by API responses via
 * useAnalyticsQuery hooks; these exist as the fallback for loading /
 * unauthenticated states and for Storybook fixtures.
 */

        ...
        >
          <div>
            <div className="w-full bg-white">
              ...
              <div className="max-w-[1700px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 mt-6">
                <div className="flex flex-col md:flex-row justify-center items-start md:items-center gap-8 md:gap-12">
                  ...
                  <div className="bg-base-white w-full md:w-[480px] rounded-lg flex-shrink-0">
                    <figure className="py-6 px-6 sm:py-8 sm:px-10">
                      <img
                        src="https://res.cloudinary.com/dtoqwn0gx/image/upload/v1753878938/navbar-image-test_pynn86.webp"
                        alt="Chatblix unified inbox preview"
                      ...
                      <div className="pt-3 text-start">
                        ...
                        <p className="body-regular-16 text-grey-medium">
                          See how teams are turning scattered DMs into one calm
                          inbox — watch a 2-minute walkthrough or book a live
                          demo with our team.
                        </p>
                      </div>
                    </figure>
